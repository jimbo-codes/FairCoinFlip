...
function Game({handleClick, flipCoin, funMode, wagerAmount, setWagerAmount, call, setCall, error}){
    ...
    <h3 className='font-header col-span-3 text-center mb-2 text-2xl'>And I'm risking:</h3>
        ...
        {wagerAmount===0.01?<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-green-600 shadow-sm hover:bg-indigo-700 outline-none ring-2 ring-offset-2 ring-red-400">.01 {curr}</button>:<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400">.01 {curr}</button>}
        {wagerAmount===0.025?<button onClick={handleBet} className="px-2 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-green-600 shadow-sm hover:bg-indigo-700 outline-none ring-2 ring-offset-2 ring-red-400">.025 {curr}</button>:<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400">.025 {curr}</button>}
        {wagerAmount===0.05?<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-green-600 shadow-sm hover:bg-indigo-700 outline-none ring-2 ring-offset-2 ring-red-400">.05 {curr}</button>:<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400">.05 {curr}</button>}
        {wagerAmount===0.075?<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-green-600 shadow-sm hover:bg-indigo-700 outline-none ring-2 ring-offset-2 ring-red-400">.075 {curr}</button>:<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400">.075 {curr}</button>}
        {wagerAmount===0.1?<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-green-600 shadow-sm hover:bg-indigo-700 outline-none ring-2 ring-offset-2 ring-red-400">.1 {curr}</button>:<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400">.1 {curr}</button>}
        {wagerAmount===0.25?<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-green-600 shadow-sm hover:bg-indigo-700 outline-none ring-2 ring-offset-2 ring-red-400">.25 {curr}</button>:<button onClick={handleBet} className="px-3 py-2 border border-transparent text-xl font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-400">.25 {curr}</button>}
    </div>
